...
def _enforce_distinctiveness(
    ...
    sig_phrases = clean_style_phrase_list(lexical.get("signature_phrases") or [], limit=6)
...
- When rewriting, use the creator's behavioral voice patterns and high-signal words naturally. Do not paste transcript hooks.
