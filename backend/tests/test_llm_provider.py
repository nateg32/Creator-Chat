...
def test_chat_prompt_uses_persona_json_and_discloses_ai_assistant():
    ...
    assert "ai creator-style assistant" in prompt.lower()
...
def test_openai_chat_path_still_works(monkeypatch):
    ...
    monkeypatch.setattr(rag, "get_chat_client", lambda model=None: fake_client)
