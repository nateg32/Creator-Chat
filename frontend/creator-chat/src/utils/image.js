/**
 * Image utilities for Creator Chat.
...
// Max dimensions for vision API. 1280 keeps chart/text screenshots readable
// while cutting upload and model image-processing time noticeably.
