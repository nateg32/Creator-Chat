...
export function ScrapeProgress({ scrapeId, onComplete, onProgress, onError }) {
  ...
  const handleCompletion = useCallback(async (progressData) => {
  ...
  const searchSteps = [
    {
      key: "sources",
      label: "Sources",
      active: ["initializing", "search"].includes(stage) && !isFinishing,
      done: percent >= 80 || isFinishing || stage === "transcripts" || stage === "finalizing" || stage === "done",
    },
    {
      key: "transcripts",
      label: "Transcripts",
      active: stage === "transcripts",
      done: percent >= 90 || isFinishing || stage === "finalizing" || stage === "done",
    },
    {
      key: "review",
      label: "Review",
      active: isFinishing || stage === "finalizing",
  ...
  return (
    <div className="scrape-progress-container">
      <div className="progress-content">
        ...
        <ol className="scrape-stage-rail" aria-label="Search stages">
