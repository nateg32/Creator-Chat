...
export function UserSettingsModal({
  ...
  const initialDisplayName = userSettings?.display_name || "";
  const initialAvatarUrl = userSettings?.profile_picture_url || "";
  const initialPresets = userSettings?.response_preferences?.presets || [];
  const initialCustomPref = userSettings?.response_preferences?.custom || "";
  const hasChanges =
    displayName !== initialDisplayName ||
    avatarUrl !== initialAvatarUrl ||
    customPref !== initialCustomPref ||
    JSON.stringify([...presets].sort()) !== JSON.stringify([...initialPresets].sort());
      ...
      >
        <div className="user-settings-header">
          <div>
            ...
            <p>How creators should recognize you and shape replies.</p>
          </div>
        ...
        <div className="user-settings-scroll">
          <section className="user-settings-section">
            <div className="user-settings-section-head">
              <h3>Profile</h3>
              <p>Your name and photo in conversation.</p>
            </div>
          ...
          <section className="user-settings-section">
            <div className="user-settings-section-head">
              <h3>Style</h3>
              <p>Choose the reply texture you prefer.</p>
            </div>
          ...
          <section className="user-settings-section">
            <div className="user-settings-section-head">
              <h3>Context</h3>
              <p>Useful background creators can adapt to.</p>
            </div>

            <div className="user-settings-form">
              <label htmlFor="custom-instructions-input">About you</label>
              <textarea
        ...
        <div className="user-settings-footer">
          ...
          <button type="button" className="primary-button" onClick={handleSave} disabled={saving || loggingOut || !hasChanges}>
